...
Page({
    data: {
        currentPageParams: "",
        currentData: {},
        despageForChat: "layerPage.js",
        despage: "layerPage.js",
        showHelloText: !1,
        isSend: !1,
        showPhoneAuth: !1,
        showAgree: !1,
    ...
    onShareAppMessage: function(e) {
        ...
        return r.trackRequest(a, s), {
            ...
            path: "/pages/layerPage/layerPage?shareToken=" + s.globalData.shareToken + "&pageId=" + this.data.pageId
        };
    },
    onLoad: function(e) {
        var a = this;
