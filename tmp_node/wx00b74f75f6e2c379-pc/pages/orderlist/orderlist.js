...
Page({
    ...
    orderFinish: function orderFinish(e) {
        var that = this;
        var orderid = e.currentTarget.dataset.orderid;
        app.getOpenId(function(openid) {
            wx.request({
    ...
    showLogistics: function showLogistics(e) {
        var orderid = e.currentTarget.dataset.orderid;
        wx.navigateTo({
            url: "../logistics/logistics?orderid=" + orderid
        });
    },
    showReview: function showReview(e) {
        var orderid = e.currentTarget.dataset.orderid;
        wx.navigateTo({
    ...
    RefundOrder: function RefundOrder(e) {
        var orderid = e.currentTarget.dataset.orderid;
    ...
    ReturnsOrder: function ReturnsOrder(e) {
        var orderid = e.currentTarget.dataset.orderid;
    ...
    loadData: function loadData(status, that, isNextPage) {
        wx.showLoading({
            title: "加载中"
        });
    ...
    pageActive: function pageActive(status, that) {
        if (status == 0) {
            that.setData({
                AllActive: "active",
                WaitPayActive: "",
