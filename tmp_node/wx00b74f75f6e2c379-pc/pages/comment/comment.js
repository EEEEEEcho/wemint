...
Page({
   ...
   */
    ...
    getProductData: function getProductData(res) {
        var that = this;
    ...
    ScoreGrade: function ScoreGrade(e) {
    ...
    UploadImg: function UploadImg(imgPath, e) {
        var that = this;
        var idx = e.currentTarget.dataset.index;
        var column = e.currentTarget.dataset.coloum;
        var skuid = e.currentTarget.dataset.skuid;
    ...
    formSubmit: function formSubmit(e) {
        ...
        var scorestr = that.data.ScoreGrade;
        //获取等级评分
                var areanamestr = that.data.TxtareaName;
        //获取控件id
