...
Page({
    ...
    getCouponsData: function getCouponsData(res) {
        var that = this;
    ...
    bingNoUseTap: function bingNoUseTap(e) {
        var that = this;
        that.setData({
            pageIndex: 0,
            couponType: 1,
    ...
    binghasUseTap: function binghasUseTap(res) {
        var that = this;
        that.setData({
            pageIndex: 0,
            couponType: 2,
    ...
    bingExpiredTap: function bingExpiredTap(e) {
        var that = this;
        that.setData({
            pageIndex: 0,
            couponType: 3,
