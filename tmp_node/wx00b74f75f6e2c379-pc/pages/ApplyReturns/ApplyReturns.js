...
Page({
   ...
   */
    ...
    GetCheckData: function GetCheckData(result) {
        var res = result.data;
        var that = this;
    ...
    ShowAfterType: function ShowAfterType(e) {
        var that = this;
        wx.showActionSheet({
    ...
    ShowResaon: function ShowResaon(e) {
        var that = this;
        wx.showActionSheet({
    ...
    ShowRefundType: function ShowRefundType(e) {
        var that = this;
        wx.showActionSheet({
    ...
    GetRefundTypeId: function GetRefundTypeId(typeName) {
        if (typeName == "退到预付款") {
            return 3;
    ...
    GetAfterSaleTypeId: function GetAfterSaleTypeId(typeName) {
        if (typeName == "退货退款") {
            return 3;
    ...
    ChooseAfterType: function ChooseAfterType(e) {
    ...
    formSubmit: function formSubmit(e) {
        ...
        that.UploadBatchImages(that, temp);
        //上传图片
        },
    UploadBatchImages: function UploadBatchImages(that, imglist) {
    ...
    AddReturnInfo: function AddReturnInfo() {
        var that = this;
        app.getOpenId(function(openid) {
            var para = {
                openId: openid,
