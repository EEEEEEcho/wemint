...
Page({
    ...
    getUserShippingAddressData: function getUserShippingAddressData(res) {
        var that = this;
    ...
    bindRadioAddressChange: function bindRadioAddressChange(e) {
        var that = this;
    ...
    bindAddAddressTap: function bindAddAddressTap(e) {
        var that = this;
        wx.showModal({
            title: "提示",
            content: "是否使用微信收货地址",
