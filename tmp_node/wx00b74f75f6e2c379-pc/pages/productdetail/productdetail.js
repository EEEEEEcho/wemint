...
Page({
    ...
    clickCouponList: function clickCouponList(e) {
        var that = this;
    ...
    clickPromoteList: function clickPromoteList(e) {
        var that = this;
    ...
    onCouponHide: function onCouponHide(e) {
        this.setData({
            backShow: "none",
            couponShow: "none"
        });
    },
    onPromoteHide: function onPromoteHide(e) {
        this.setData({
            backShow: "none",
            promoteShow: "none"
        });
