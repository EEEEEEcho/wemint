var e = getApp(), t = require("../../components/picker_datetime.js"), a = require("../../pages/shop/AddrManage.js"), n = require("../../components/city-picker.js"), i = require("../shop/ShopUtil.js");
...
Page({
    ...
    onLoad: function(i) {
        var o = this;
        e.registerGlobalFunctions(o), this.setData({
            optionsObj: i
