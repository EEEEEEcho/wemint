...
function t(e, t, a) {
    wx.request({
        ...
        data: {
            crm_code: n.crm_code,
            account_type: 1,
            account_code: r.globalData.teacher.id,
            currentPage: e,
            rowCountPerPage: t
        },
        header: {
...
var c, n = require("../../../utils/main.js"), r = (require("../../../utils/qiniuUploader"), 
getApp());
...
Page({
    ...
    }, e(c, "actionSheetHidden2", !0), e(c, "actionSheetHidden3", !0), e(c, "showModalStatus", !1), 
    c),
    onLoad: function() {
        var e = this;
        n.initQiniu();
        var t = r.globalData.teacher.bp_image;
        null != t && "" != t || (t = "http://p7mq9gjza.bkt.clouddn.com/t_me_head.png"), 
        this.setData({
            teacher: r.globalData.teacher,
            bpImage: t
        }), wx.getSystemInfo({
            success: function(t) {
                e.setData({
    ...
    selLike: function(e) {
        var t = this, i = this, c = e.currentTarget.dataset.circle_id, n = e.currentTarget.dataset.is_like, r = e.currentTarget.dataset.index;
        a(c, n, function(e) {
            i.data.circleList[r].is_like = e.dataInfo.isLike, i.data.circleList[r].likeNameStr = e.dataInfo.likeNameStr, 
            t.setData({
    ...
    bindReply: function(e) {
        var t = this, a = e.currentTarget.dataset.index, i = e.currentTarget.dataset.cpccIndex, c = e.currentTarget.dataset.circle_id, n = e.currentTarget.dataset.parent_id, r = e.currentTarget.dataset.parent_tid, o = e.currentTarget.dataset.cid, s = e.currentTarget.dataset.parent_name;
        r == t.data.teacher.id ? this.setData({
    ...
    addCommentL: function() {
        var e = this, t = this, a = t.data.releaseIndex, c = t.data.releaseCircle_id, n = t.data.releaseParent_id;
        i(c, t.data.content, n, function(i) {
            t.data.circleList[a].cpccList = i.dataInfo.cpccList, e.setData({
