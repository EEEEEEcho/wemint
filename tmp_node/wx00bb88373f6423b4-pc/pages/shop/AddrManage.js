            ...
            e.app.sendRequest({
                ...
                success: function(t) {
                    t.success ? e.loadUserAddrList(function() {
                        d == e.page.data.currentAddrId && (0 !== e.page.data.userAddrList.length ? e.setCurrentAddrById(e.page.data.userAddrList[0].ID) : (e.page.setData({
                            defaultAddr: ""
                        }), e.setCurrentAddrById(0)));
                    }) : e.app.showModal({
                        title: "提示",
                        content: "操作失败：" + t.msg
                    });
        ...
        d.RealName ? d.ContactNumber ? 0 != /^((1\d{10})|(\d{3,4}\-\d{6,9}))$/.test(d.ContactNumber) ? d.PostCode && 0 == /^\d{6}$/.test(d.PostCode) ? e.app.showModal({
            ...
            success: function(t) {
                t.success ? (e.page.setData({
                    ...
                    d.AddrId == e.page.data.currentAddrId && e.setCurrentAddrById(d.AddrId), e.page.setData({
                        currentAddr: ""
                    });
                })) : e.app.showModal({
                    title: "提示",
