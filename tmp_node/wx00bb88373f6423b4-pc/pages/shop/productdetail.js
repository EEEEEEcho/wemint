var t = getApp(), a = require("../../components/utils/imgutil.js"), e = require("ShopUtil.js"), i = require("../../common.js");
...
Page({
    ...
    onLoad: function(a) {
        var s = this;
        s.url = t.getPageUrl(s, a), t.registerGlobalFunctions(s), i.initCommonModules(), 
        this.setData({
            queryparams: a,
            scrviewFlag: !1
    ...
    buyNow: function() {
        ...
        this.data.getPageFlag && (this.setData({
            ...
            getPageFlag: !0
        })) : e.addProcuctToCart(this.data.productInfo.ProductID, this.data.SkuID, this.data.count, 1, function(a) {
            t.setData({
                flag2: !1,
                flag: !1,
                flag3: !1
